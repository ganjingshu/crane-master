...
static Graph_Data_t UI_RedBox[1];      // 红色小方框
static Graph_Data_t UI_shoot_line[10]; // 射击准线
static Graph_Data_t UI_Energy[3];      // 电容能量条
static String_Data_t UI_State_sta[6];  // 机器人状态,静态只需画一次
static String_Data_t UI_State_dyn[6];  // 机器人状态,动态先add才能change
static uint32_t shoot_line_location[10] = {540, 960, 490, 515, 565};//y,x,y,y,y初始位置
...
void MyUIInit()
{
    ...
    // 绘制发射基准线
    UILineDraw(&UI_shoot_line[0], "sl0", UI_Graph_ADD, 7, UI_Color_White, 3, 710, shoot_line_location[0], 1210, shoot_line_location[0]);//x,线长从710-1210
    UILineDraw(&UI_shoot_line[1], "sl1", UI_Graph_ADD, 7, UI_Color_White, 3, shoot_line_location[1], 340, shoot_line_location[1], 740);//y,线长从340-740
    UILineDraw(&UI_shoot_line[2], "sl2", UI_Graph_ADD, 7, UI_Color_Yellow, 2, 810, shoot_line_location[2], 1110, shoot_line_location[2]);//x,线长从810-1110
    UILineDraw(&UI_shoot_line[3], "sl3", UI_Graph_ADD, 7, UI_Color_Yellow, 2, 810, shoot_line_location[3], 1110, shoot_line_location[3]);//x,线长从810-1110
    UILineDraw(&UI_shoot_line[4], "sl4", UI_Graph_ADD, 7, UI_Color_Yellow, 2, 810, shoot_line_location[4], 1110, shoot_line_location[4]);//x,线长从810-1110
    ...
    // 红色小方框 - 位置在中心偏下 (900, 500)，大小40x40
    UIRectangleDraw(&UI_RedBox[0], "rbx0", UI_Graph_ADD, 7, UI_Color_Purplish_red, 3, 900, 500, 940, 540);
    UIGraphRefresh(&referee_recv_info->referee_id, 1, UI_RedBox[0]);
}
