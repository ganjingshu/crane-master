...
#define PITCH_LIMIT_MIN -28
#define PITCH_LIMIT_MAX 25
...
static Vision_Recv_s vision_recv_cmd_data;
...
static BMI088Instance *bmi088; // 云台IMU(牢步现在云台有装IMU吗？？？）

static float angle1_data=0;  //调位置环用的变量
static float speed1_data=0;  //调速度环用的变量
float vt = 100;
...
void GimbalTask()
{
    ...
    SubGetMessage(vision_recv_data_sub, &vision_recv_cmd_data);
    ...
    // 设置反馈数据,主要是imu和yaw的ecd
     ...
     angle1_data = gimba_IMU_data->Gyro[2]*100;
